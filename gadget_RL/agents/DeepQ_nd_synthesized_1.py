...
class DeepQ_nd_synthesized_1(object):
    ...
    def __init__(self, conf, action_size, state_size, device):
        ...
        self.state_size = state_size if self.with_angles else state_size - self.num_layers*self.num_qubits*7
        # print('---------------')
        ...
        self.translate = dictionary_of_actions_nd_synthesized_1(self.num_qubits)
        self.rev_translate = dictionary_of_actions_nd_synthesized_1(self.num_qubits)
